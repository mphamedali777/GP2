...
class NaresScreen extends StatefulWidget {
  const NaresScreen({super.key});

  @override
  State<NaresScreen> createState() => _NaresScreenState();
}

class _NaresScreenState extends State<NaresScreen> {

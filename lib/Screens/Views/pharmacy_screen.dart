...
class Pharmacy_Screen extends StatefulWidget{
  @override
  State<Pharmacy_Screen> createState() => _Pharmacy_ScreenState();
}

class _Pharmacy_ScreenState extends State<Pharmacy_Screen> {
  @override
